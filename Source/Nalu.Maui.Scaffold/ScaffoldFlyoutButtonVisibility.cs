...
/// The button only ever shows when the drawer is actually available (content resolves and its
/// mode enables it), and never on modal pages.
/// </summary>
public enum ScaffoldFlyoutButtonVisibility
{
    ...
    /// <summary>The drawer button always shows while the drawer is available (side by side with the back button while pages are pushed).</summary>
    Visible,
