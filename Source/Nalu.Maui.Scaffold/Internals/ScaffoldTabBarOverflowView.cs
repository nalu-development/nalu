...
/// template (icon over label, badge, selection pill, fixed <see cref="ScaffoldTabBarView.ItemWidth"/>
...
internal sealed class ScaffoldTabBarOverflowView : Border
{
    ...
    public ScaffoldTabBarOverflowView(ScaffoldTabBarView barView, Func<Task> closeAsync)
    {
        ...
        StrokeShape = new RoundRectangle { CornerRadius = new CornerRadius(barView.OverflowPanelCornerRadius) };
