...
/// </summary>
/// <param name="FractionX">Horizontal translation as a fraction of the page width (positive = right; physical, not RTL-mirrored).</param>
/// <param name="FractionY">Vertical translation as a fraction of the page height (positive = down).</param>
...
/// <summary>
/// Cross-platform, declarative push/pop page transition: <see cref="Enter"/> describes
...
/// <see cref="SlideFromBottom"/> for modal-mode pages → scaffold-level value →
/// <see cref="Default"/>. The spec is resolved from the page that was PUSHED: it enters with
/// it and leaves with it reversed.
/// </summary>
