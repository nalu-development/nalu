...
file class NaluShellBottomNavViewAppearanceTracker : ShellBottomNavViewAppearanceTracker
{
    ...
    public NaluShellBottomNavViewAppearanceTracker(IShellContext shellContext, IMauiContext mauiContext, ShellItem shellItem)
    ...
    public override void SetAppearance(BottomNavigationView bottomView, IShellAppearanceElement appearance)
    {
        ...
        var tabBarView = NaluShell.GetTabBarView(_shellItem);
        
        // Use the provided view or fallback to a default red Grid
        Microsoft.Maui.Controls.View mauiBar = tabBarView ?? new Grid
        {
