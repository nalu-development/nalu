...
*   **Navigation** [![Nalu.Maui.Navigation NuGet Package](https://img.shields.io/nuget/v/Nalu.Maui.Navigation.svg)](https://www.nuget.org/packages/Nalu.Maui.Navigation/) [![Nalu.Maui NuGet Package Downloads](https://img.shields.io/nuget/dt/Nalu.Maui.Navigation)](https://www.nuget.org/packages/Nalu.Maui.Navigation/)
    ...
    *   🧩 **Plays nicely with component-based UI frameworks**: apps built on [MauiReactor](https://github.com/adospace/reactorui-maui), Comet or [BlazorBindings.Maui](https://github.com/Dreamescaper/BlazorBindings.Maui) get the same first-class navigation — `Nav.Push<MyComponent>()` with lifecycle hooks, guards and typed intents directly on the component, through the public `IComponentPageFactory` extension point (no adapter packages: the MauiReactor bridge is a small copy-paste class — see [MauiReactor Component Pages](https://nalu-development.github.io/nalu/navigation-mauireactor.html)).
