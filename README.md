...
# Nalu [![GitHub Actions Status](https://github.com/albyrock87/Nalu/actions/workflows/build.yml/badge.svg?branch=main)](https://github.com/albyrock87/Nalu/actions/workflows/build.yml)
...
<Button Command="{nalu:NavigateCommand}" Text="Go to main page">
    <Button.CommandParameter>
        <nalu:AbsoluteNavigation Intent="{Binding MyIntentValue}">
            <nalu:NavigationSegment x:TypeArguments="pageModels:SomePageModel" />
...
#### You don't care about those awesome thing?

If you're here just because you want page/vm disposal on the standard `NavigationPage` or `Shell` navigation, you can use the following methods in the relative constructor.
