...
public class ViewConstraintTests
{
    ...
    [InlineData("1M", "1M", 20, 40, "r:r:parent,l:l:parent", 40, 60, 0, 40)]
    [InlineData("1M", "1M", 20, 40, "r:r:parent,l:l:parent", 0, 20, 0, 40, "0", "0,0")]
    [InlineData("1M", "1M", 20, 40, "r:r:parent,l:l:parent", 80, 100, 0, 40, "0", "1,0")]
    [InlineData("1M", "1M", 20, 40, "r:r:parent,l:l:parent", 20, 40, 0, 40, "20,0", "0,0")]
    [InlineData("1M", "1M", 20, 40, "r:r:parent,l:l:parent", 60, 80, 0, 40, "20,0", "1,0")]
    ...
    [InlineData("0.5C", "0.5C", 20, 40, "t:t:parent,l:l:parent,r:r:parent,b:b:parent", 25, 75, 50, 150)]
