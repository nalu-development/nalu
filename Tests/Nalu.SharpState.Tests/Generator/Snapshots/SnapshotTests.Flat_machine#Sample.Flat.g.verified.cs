...
namespace Sample
{
    public partial class Flat
    {
        ...
        protected interface IStateConfigurator : IStateConfiguration
        {
            ...
            /// </summary>
            /// <param name="configure">Configures the <see cref="global::Nalu.SharpState.ISyncStateTriggerBuilder<global::Sample.Ctx, State, string>"/> used by <see cref="IActor.Connect(string)"/>.</param>
            /// <returns>The same configurator for chaining.</returns>
